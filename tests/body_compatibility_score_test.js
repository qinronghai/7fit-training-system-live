...
assert(first.length>=2,'BODY-04 L2 secondary requires representative candidates');
...
// All four Body families expose scored, explainable recommendations.
...
// Horizontal pull PRIMARY makes BODY-03 SECONDARY prefer the opposite pull direction.
...
// A manual context change must rerank at least one common downstream candidate.
...
// Local fatigue is advisory and captures push-chain accumulation without changing Direct Work Sets.
const syntheticPush={
...
// Sequence audit detects a low-value isolation pre-fatiguing a later high-complexity main lift.
...
// 16 generated states remain deterministic, legal, and score-backed.
