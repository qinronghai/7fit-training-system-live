(function(){
  ...
  function render(result){
    ...
    return `<section class="conflict-box f111-course-check ${status.toLowerCase()}"><div class="f111-course-check-head"><span class="f111-course-check-status">${status==='PASS'?'✓':'×'} ${label}</span><small>课程检查</small></div>${details}</section>`;
  }
