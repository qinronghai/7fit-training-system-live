(function(){
  ...
  function render(route){
    ...
    const resolvedSession=resolveResolvedSession(sessionId,recipeId,level),selected=resolvedSession.main.content.map(slot=>slot.actionId),groups=selectedTrainingIds(sessionId,selected),result=resolvedSession.conflictContext,recoveryResult=window.V14RecoveryMatcher.match(resolvedSession);
