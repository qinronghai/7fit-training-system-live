(function(){
  ...
  function coachModeSwitch(active){return `<nav class="coach-mode-switch"><a class="${active==='preset'?'active':''}" href="#/coach/f111">7Fit 推荐预设</a><a class="${active==='compose'?'active':''}" href="#/coach/f111/compose">自由组合编课</a></nav>`;}
