...
PREP = {
    ...
    "warmup_doll_squat": typed_rec("mobility", ["内收肌群", "臀大肌"], ["腘绳肌", "股四头肌"], ["腹壁", "足踝稳定肌群"], ["髋关节", "膝关节", "踝关节"], ["髋屈/伸", "膝屈伸", "踝背屈"]),
    "warmup_single_leg_swallow_balance": typed_rec("activation", ["臀中肌", "腘绳肌"], ["臀大肌", "足踝稳定肌群"], ["腹壁", "骨盆稳定肌群"], ["髋关节", "膝关节", "踝关节"], ["单腿髋铰链", "骨盆控制", "足踝平衡"]),
    "warmup_single_leg_hamstring_scoop": typed_rec("mobility", ["腘绳肌"], ["腓肠肌", "臀中肌"], ["腹壁", "足踝稳定肌群"], ["髋关节", "膝关节", "踝关节"], ["单腿髋屈", "膝伸", "踝背屈"], tissue=["腘绳肌", "小腿后侧"], avoid=["膝后腘窝", "急性疼痛区域"]),
